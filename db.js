...
const DB = {
  warmup: {
    ...
    exercises:[
      ...
      { id:'torso-twists', name:'Torso Twists',        icon:'🌪️', reps:12, restCue:'Stand tall — arms out to the sides',       cue:'Rotate torso left and right',             restPose:'armsWide', workPose:'armsAsym', checkRest:lmFn.armSym,  check:lmFn.armAsym },
      ...
      { id:'side-crunches', name:'Standing Side Crunches', icon:'🤸', reps:12, restCue:'Stand tall — arms overhead',           cue:'Crunch elbow down to lifted knee',        restPose:'armsUp', workPose:'armsAsym', checkRest:lmFn.armSym,    check:lmFn.armAsym },
      { id:'hip-circles', name:'Hip Circles',          icon:'🌀', reps:10, restCue:'Stand — hands on hips, feet shoulder-width', cue:'Make big circles with your hips',       restPose:'stand', workPose:'lunge', checkRest:lmFn.hipSym,  check:lmFn.hipRot },
  ...
  workout: {
    ...
    exercises:[
      ...
      { id:'crunches',    name:'Standard Crunches',    icon:'🧘', reps:15, restCue:'Lie on back — knees bent, feet flat',      cue:'Lift shoulders off the floor',            restPose:'sit', workPose:'sitUp', checkRest:lm=>lm[0].y > lm[11].y, check:lm=>lm[0].y < lm[11].y-0.05 },
      { id:'leg-raises',  name:'Leg Raises',           icon:'🦵', reps:12, restCue:'Lie on back — legs extended',             cue:'Lift legs to 90 degrees',                 restPose:'sit', workPose:'kneeUp', checkRest:lm=>lm[27].y > lm[23].y, check:lmFn.isLegRaise },
      { id:'side-plank',  name:'Side Plank Hold',      icon:'🛡️', reps:8,  restCue:'Lie on side — elbow under shoulder',   cue:'Lift hips — hold straight line',          restPose:'sit', workPose:'plank', checkRest:lm=>Math.abs(lm[11].y-lm[12].y)>0.1, check:lm=>Math.abs(lm[11].y-lm[12].y)<0.05 },
    ]
  },
  stretch: {
